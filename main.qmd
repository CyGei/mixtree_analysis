...
future_walk(seq_along(epidemic_sizes), function(i) {
  ...
  saveRDS(sim, paste0("data/sims/sims_", i, ".rds"))
...
future_walk(unique(metadata$pair_id), function(id) {
  ...
  saveRDS(chains, paste0("data/chains/chain_", id, ".rds"))
}, .options = furrr_options(seed = 123))
...
future_walk(asplit(metadata, 1), function(param) {
  ...
  saveRDS(p_value, paste0("data/p_values/adonis/p_values_", param[["pair_id"]], ".rds"))
}, .options = furrr_options(seed = 123))
...
future_walk(asplit(metadata, 1), function(param) {
  ...
  saveRDS(p_value, paste0("data/p_values/chisq/p_values_", param[["pair_id"]], ".rds"))
}, .options = furrr_options(seed = 123))
```
